...
public class BasicTests {
	...
	public void string() {
		...
		String result = (String)proxy.execute("echo", p1);
	...
	@Test
	public void intEcho(){
		int i = ((Number)proxy.execute("echo", 100)).intValue();
		assertEquals(100, i);
	}
	
	@Test
	public void addInteger(){
		int result = ((Number)proxy.execute("add", 128, 12)).intValue();
	...
	public void addDouble(){
		 ...
		 */
		double result = ((Number)proxy.execute("add", 128.23d, 12.01d)).doubleValue();
		assertEquals(140, result);
	}
	...
	public void remoteSubstring(){
		...
		String result = (String)proxy.execute("substring", param, 100, 150);
